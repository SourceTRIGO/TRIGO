...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TRIGO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("TR", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S TRIGO -X kill
screen -S TRIGO ./TRIGO
done
]])  
file:close() 
...
local TRIGO_Msg = ''  
if msgs < 100 then 
TRIGO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TRIGO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TRIGO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TRIGO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TRIGO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TRIGO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TRIGO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TRIGO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TRIGO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TRIGO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TRIGO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TRIGO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TRIGO_Msg = 'رب التفاعل'  
end 
return TRIGO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceTRIGO(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,TRIGO_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس تريكو \n ❃∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..TRIGOk..''..TRIGO..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'KOO_KO')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KOO_KO')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
local TRIGO1_Msg = database:get(bot_id.."TRIGO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TRIGO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KOO_KO')..') \n ❃∫ '..TRIGO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TRIGO_Msg and not Special(msg) then  
local TRIGO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TRIGO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TRIGO_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/KOO_KO)}\n ❃∫ ["..TRIGO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/KOO_KO)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━━━━━━━━≫
 ❃∫ ↬TRIGO TEAM
 ≪━━━━━━━━━━━━━≫
 ❃∫ ↬[Channel TRIGO](t.me/KOO_KO) 
≪━━━━━━━━━━━━━≫
 ❃∫ ↬[Information](t.me/KOO_KO)
≪━━━━━━━━━━━━━≫
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'KOO_KO')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'KOO_KO')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات تريكو\n ❃∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس تريكو ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/KOO_KO) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس تريكو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KOO_KO')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KOO_KO')..')'
...
database:set(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TRIGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TRIGO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TRIGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TRIGO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TRIGO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TRIGO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TRIGO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TRIGO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TRIGO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TRIGO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TRIGO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local TRIGO_Msg = database:get(bot_id.."TRIGO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TRIGO_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'KOO_KO')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تريكو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تريكو')
local TRIGO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..TRIGO_Msg[math.random(#TRIGO_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تريكو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'KOO_KO')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TRIGOdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
zh = https.request('https://rudi-dev.tk/Amir1/TRIGO.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫━━━━━━TR━━━━━━❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫━━━━━━TR━━━━━━❃∫○ٴ\n❃∫ 彡 .[TRIGO 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/KOO_KO)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/TRIGO.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/TRIGO.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تريكو')
...
TRIGO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TRIGO)
...
------------------------------------------------------------------------
local TRIGOAbot = database:get(bot_id.."TRIGO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TRIGOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TRIGOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TRIGO1_Msg = database:get(bot_id.."TRIGO1:Add:Filter:Rp2"..text..result.chat_id_)   
if TRIGO1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..TRIGO1_Msg)
